...
public class UtilidadesControlador {
  ...
  public static String seleccionarArchivo(ActionEvent e, Button BotonArchivoTexto, VBox inicio, String tipo) {
    File file = null;
    FileChooser fileChooser = new FileChooser();
    fileChooser.getExtensionFilters().addAll(
        new FileChooser.ExtensionFilter("Archivos" + tipo, "*."+tipo));
    if (e.getSource().equals(BotonArchivoTexto)) {
      file = fileChooser.showOpenDialog(inicio.getScene().getWindow());
    } else {
      TipoDatoIncorrecto("Error al leer el archivo");      
  ...
  public static String guardarArchivo (ActionEvent e, Button BotonArchivo, VBox inicio, String tipo) {
      File file = null;
      FileChooser fileChooser = new FileChooser();

      //Set extension filter for text files
      FileChooser.ExtensionFilter extFilter = new FileChooser.ExtensionFilter("Archivos " + tipo, "*."+tipo);
