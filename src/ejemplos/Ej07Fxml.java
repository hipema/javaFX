...
public class Ej07Fxml extends Application {
  ...
  public void start(Stage primaryStage) throws IOException {
    ...
    fxml1.setLocation(Ej07Fxml.class.getResource("/fxmlEjemplos/Ej07FXML.fxml"));
    FXMLLoader fxml2 = new FXMLLoader(this.getClass().getResource("/fxmlEjemplos/Ej07FXML2.fxml"));
    FXMLLoader fxml3 = new FXMLLoader(this.getClass().getResource("/fxmlEjemplos/Ej07FXML3.fxml"));
